    ...
    <div className='hero-bg relative'>
      ...
      {/* hero section */}
        ...
        <div className='py-10 text-white bg-black'>
          ...
          <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-10'>
            {/* left side */}
         ...
         <div className='py-10 text-white bg-black'>
         <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-10'>
          {/* left side */}
          ...
          <div className='flex-1 text-center md:text-left'>
              <h2 className='text-4xl md:text-5xl font-extrabold mb-4 text-balance'>Download your show to watch offline</h2>
         ...
         <div className='py-10 text-white bg-black'>
          ...
          <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-10'>
            ...
            <div className='flex-1 relative overflow-hidden'>
              ...
              <video className='absolute top-2 left-1/2 -translate-x-1/2 h-4/6 z-10 w-[63%]'
              playsInline
              autoPlay={true}
              muted
              loop
